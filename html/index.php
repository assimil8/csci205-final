...
<html>
    <head>
        <title>KYLE MORRIS CSCI 205 FINAL</title>
...
****************************************/ 
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST"){
	$input = "./main"." ".$_POST["GPIOcontrol"];
    //echo $input."<br>";
    exec($input, $output);
    if ($_POST["GPIOcontrol"]=="s")
	   echo "<div class='container'>".$output[0]."</div>";
	if ($_POST["GPIOcontrol"]=="o")
	   echo "<div class='container'>Turned LED on!<br></div>";
    if ($_POST["GPIOcontrol"]=="f")
	   echo "<div class='container'>Turned LED off!<br></div>";
